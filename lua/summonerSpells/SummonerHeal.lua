function finishCasting()
	...
	if mostWoundedAlliedChampion then
		...
		local buff = Buff.new("Haste", 10.0, BUFFTYPE_TEMPORARY, mostWoundedAlliedChampion, owner)
		buff:setMovementSpeedPercentModifier(27)
	...
	local buff2 = Buff.new("Haste", 10.0, BUFFTYPE_TEMPORARY, owner)    
	buff2:setMovementSpeedPercentModifier(27)    
	addBuff(buff2, owner)
